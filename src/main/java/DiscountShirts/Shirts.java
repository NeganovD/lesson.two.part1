...
public class Shirts {
    public static void main(String[] args) {
        ...
        int priceOfShirt = 300; // цена одной рубашки без скидки
        int shirtsInBasket = 10; // количество уже выбранных рубашек
        int quantityShirtsForGetDiscount = 5; // количество рубашек, которые надо купить, чтобы получить скидку.
        ...
        double discount = 30; // Процент скидки
