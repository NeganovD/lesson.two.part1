...
public class EmployeesOnProject {
    public static void main(String[] args) {
        ...
        int quantityProgrammers = 10; // количество программистов
        int quantityQAsPerProgrammer = 1; // количество тестировщиков, необходимое, чтобы протестировать код одного программиста.
        int quantityTechSupportsPerProgrammer = 2; // количество специалистов поддержки, необходимое, чтобы обработать вопросы, возникающие у пользователей по поводу кода, написанного одним программистом.
