...
public class SarumanAndLannister {
    public static void main(String[] args) {
        ...
        final int lannistersTroopers = 3000; // Количество пехотинцев у Ланнистеров
        final int sarumansOrcs = 2500; // Количество орков у Сарумана
        int totalQuantityOfTwoTroops = lannistersTroopers + sarumansOrcs; // Общее количество пехоты в союзе Ланнистеров и Сармана
